...
// =============================================
const TEMPLATE_DATA = [
  { cat:'estate', thumbSrc:'img/designer-01.jpg', tags:[{t:'포트폴리오',cls:'tmpl-tag-industry'},{t:'프리미엄',cls:'tmpl-tag-free'}], title:'디자이너 전용<br>포트폴리오 템플릿', desc:'디자이너 전용 템플릿입니다. 간단하게 수정 및 깃허브 셋팅 가능합니다.', price:'₩10,000~', priceCls:'free', previewUrl:'designer-portfolio-template.html' },

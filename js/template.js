...
/* ── 카드 데이터 ── */
const cards = [
  { id:0, cat:'estate', title:'이력서', desc:'대기업·컨설팅 인사담당자가 검토하는 순서 기준으로 설계한 이력서 템플릿입니다. 정보 위계와 표준 제출 구조에 최적화되어 있습니다.', tag:'대기업·컨설팅', free:false, features:['정공법형·컨설팅형·국문표준형 3종 레이아웃','한글·워드·PDF·Notion 4포맷 제공','자기소개서 틀 + 경력기술서 별지 포함','A4 1장 출력 여백 검증 완료'] },
  { id:1, cat:'hospital', title:'원장 신뢰형 병원 상담 랜딩', desc:'원장 소개·수상 이력·환자 후기 섹션이 핵심. 신뢰 기반 상담 예약 전환에 최적화된 구조입니다.', tag:'병원·의원', free:true, features:['원장 프로필 + 수상·인증 섹션','환자 후기 카드 슬라이더','카카오 채널 즉시연결 CTA','모바일 최적화 완료'] },
  { id:2, cat:'hospital', title:'비포·애프터 시술 특화 랜딩', desc:'전후 사진 갤러리 + 실시간 예약 폼 + 한정 프로모션 배너 포함.', tag:'병원·의원', free:false, price:'₩12,000', features:['비포·애프터 갤러리 섹션','실시간 예약 폼 연동','한정 프로모션 카운트다운','카카오·전화 플로팅 버튼'] },
  { id:3, cat:'diet',     title:'체험단 모집 다이어트 랜딩',  desc:'한정 체험단 배너 + 체중감량 후기 카드 + 긴박감 유도 카운트다운.', tag:'헬스·다이어트', free:true, features:['체험단 모집 배너','후기 카드 슬라이더','카운트다운 타이머','카카오 즉시연결'] },
  { id:4, cat:'diet',     title:'PT 등록 전환 헬스장 랜딩',   desc:'트레이너 소개·수강 후기·PT 패키지 비교 섹션 포함. 카카오 즉시연결.', tag:'헬스·다이어트', free:false, price:'₩12,000', features:['트레이너 프로필 카드','수강 후기 슬라이더','PT 패키지 비교표','카카오 즉시연결 CTA'] },
  { id:5, cat:'academy',  title:'합격률 강조 입시학원 랜딩',  desc:'성적향상 그래프 + 합격 후기 + 강사 프로필 섹션. 무료 상담 신청 폼.', tag:'학원·교육', free:true, features:['성적향상 그래프 섹션','합격 후기 카드','강사 프로필','무료 상담 신청 폼'] },
  { id:6, cat:'academy',  title:'커리큘럼 중심 어학원 랜딩',  desc:'단계별 커리큘럼 타임라인 + 레벨 테스트 CTA + 원비 비교표 포함.', tag:'학원·교육', free:false, price:'₩12,000', features:['커리큘럼 타임라인','레벨 테스트 CTA','원비 비교표','카카오 즉시연결'] },
  { id:7, cat:'estate',   title:'매물 신뢰형 부동산 상담 랜딩', desc:'매물 카드 섹션 + 공인중개사 소개 + 즉시 전화·카카오 플로팅 버튼.', tag:'부동산', free:true, features:['매물 카드 섹션','공인중개사 소개','즉시 전화·카카오 버튼','모바일 최적화'] },
  { id:8, cat:'beauty',   title:'시술 전환형 피부샵 랜딩',    desc:'시술 메뉴 카드 + 피부 고민별 필터 + 당일 예약 강조 CTA 섹션.', tag:'피부·뷰티', free:true, features:['시술 메뉴 카드','피부 고민 필터','당일 예약 CTA','카카오 즉시연결'] },
];
